...
! function($) {
	...
	$.chungTimePicker = function(element, options) {
		...
		function createMinutesWrap() {
			...
			switch(obj.options.viewType) {
				case 0:
					title.find('tr').append('<th class="prev js-back-hours"><i class="icon-arrow-left"></i></th><th colspan="4" class="title">Minuto</th>');
					break;
				case 1:
					title.find('tr').append('<th colspan="6" class="title">Minuto</th>');
					break;
				default:
					console.log(obj.errorPrefix + 'viewType Error');
					break;
		...
		function createBottomOperate() {
			switch(obj.options.viewType) {
				case 0:
					obj.timepicker_bottom.empty().append('<span class="bottom-btn js-clear">Limpar</span>')
						.append('<span class="bottom-btn js-cancel">Cancelar</span>');
					break;
				case 1:
					obj.timepicker_bottom.empty().append('<span class="bottom-btn label label-default js-clear">Limpar</span>')
						.append('<span class="bottom-btn label label-warning js-cancel">Cancelar</span>')
						.append('<span class="bottom-btn label label-primary js-confirm">Confirmar</span>');
