      ...
      <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center">
        ...
        <div class="card card-signup">
          ...
          <form class="form" action="<?php echo SITE."login/logar";?>" method="post">
            ...
            <h3 class="mt-0">GÓES</h3>

            <p class="help-block">Sistemas de Segurança e Automação</p>

            <div class="content">

              <div class="form-group">

                <input type="email" class="form-control underline-input" placeholder="Usuario" name="idUser" id="idUser" >
